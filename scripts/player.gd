...
var available_summons: Array = ["None", "Earth Hammer", "Earth Golem", "Earth Trap", "Earth Impale", "Fire Beam", "Petrify", "Tornado", "Earth Burst", "Thunder Burst", "Fire Bite", "Electric Trap"]
